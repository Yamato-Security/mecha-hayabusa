...
### Verwendung des investigate Skill
```
...
Ein HTML-Bericht wird erstellt. Ein Beispiel finden Sie im Ordner "samples".
...
### Zusätzliche Untersuchung und Erklärung anfordern
