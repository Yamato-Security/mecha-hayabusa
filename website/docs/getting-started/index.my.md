...
### investigate Skill ကို အသုံးပြုပါ
```
...
HTML အစီရင်ခံစာတစ်ခု ထုတ်လုပ်ပေးမည်ဖြစ်သည်။ နမူနာတစ်ခုအတွက် "samples" ဖိုလ်ဒါကို ကြည့်ပါ။
...
### ထပ်ဆောင်း စုံစမ်းစစ်ဆေးမှုနှင့် ရှင်းလင်းချက်ကို တောင်းဆိုပါ
